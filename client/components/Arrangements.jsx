...
const Arrangements = ({ statsInfo }) => (
  ...
  <ArrangementsWrapper>
    ...
    <ArrangementsBorder>
      ...
      ? null 
      : <ArrangementsBorder>{ statsInfo.bedrooms > 1 && statsInfo.beds < 4 ? <Bed><div><i class="fas fa-bed"></i></div><div>Bedroom 2</div><div>1 King Bed</div></Bed> : <Bed><div><i class="fas fa-bed"></i></div><div>Bedroom 2</div><div>2 Queen Beds</div></Bed> }</ArrangementsBorder>}
  </ArrangementsWrapper>
)
